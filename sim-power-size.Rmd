---
title: "Monte Carlo Simulation Practice"
subtitle: 'A replication of analyses presented in Muthén & Muthén (2002)'
author: "Adam Garber"
date: "1/28/2020"
output:
...
Hallquist, M. N., & Wiley, J. F. (2018). [\textcolor{blue}{MplusAutomation: An R Package for Facilitating Large-Scale Latent Variable Analyses in Mplus.}](https://www.tandfonline.com/doi/pdf/10.1080/10705511.2017.1402334) Structural equation modeling: a multidisciplinary journal, 25(4), 621-638.

***

## Create an R-Project:

### Download repository here: \textcolor{blue}{https://github.com/garberadamc/SIM-REPLICATION}
...
knitr::include_graphics(here("figures", "cfa_path_diagram.png"))
```
...
```{r, echo=FALSE, eval=TRUE, out.width = "50%", out.height= "50%", fig.pos="h"}
knitr::include_graphics(here("figures", "skew.png"))
```
